...
function build_with_SelectFuzz() {
    ...
    for TARG in "${@:2}"; do
        ...
        for BUG_NAME in "${str_array[@]:1}"; do
            ...
            mv $TMP_DIR /info/SelectFuzz/temp_$BIN_NAME-$BUG_NAME
...
build_with_SelectFuzz "binutils-2.28" \
    "objdump 2017-8392 2017-8396 2017-8397 2017-8398" 

wait

build_with_SelectFuzz "binutils-2.29" "nm 2017-14940"
